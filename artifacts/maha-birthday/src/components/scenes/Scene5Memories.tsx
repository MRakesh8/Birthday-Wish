...
const TAMIL_LINES = [
  "தவறு என்று தெரிந்த பின் எதற்கு கேட்க வேண்டும் மன்னிப்பு?",
  "நன்றி கூறினேன், நீ என்னை ரசித்ததற்கு...",
  "வேண்டாம் என்றுதான் சொன்னார்கள், ஏனோ தெரியவில்லை; மனம் திரும்ப சேரத் துடிக்கிறது.",
  "காத்திருந்த எனக்குத்தான் தெரியும், நீ வரமாட்டாய் என்று...",
  "வந்திருக்கலாம் தானே?",
  "உன் உதட்டில் சிறிது சிரிப்பைப் பார்த்திருப்பேன்,",
  "என் உதட்டிலும் தான்..! பரவாயில்லை...",
  "நான் காத்திருந்த போது வராத நீ,",
  "நான் அந்த இடத்தை விட்டு சென்ற பின் அலைபேசியில் அழைக்கிறாயே... அதற்கு காரணம் என்ன?",
  "அலைபேசியில் இரண்டு வார்த்தைகள் பேசிவிட்டு,",
  "\"Sorry\" என்று செய்தி அனுப்புவது எதற்கு?",
  "முதலில் உன்னை பார்த்ததும்,",
  "முடிவில் உன்னை பார்த்ததும்",
  "சிறு தொலைவில் தான்...",
  "நான் உன்னை முதலில் பார்த்ததும் ரசிக்கத் தொடங்கினேன்,",
  "உன்னுடைய அசைவுகளால்..."
];
      ...
      >
        ...
        >
          <button
            onClick={onComplete}
            disabled={!showNext}
            className={`w-[min(100%,280px)] sm:w-auto px-6 py-3 sm:px-8 sm:py-4 rounded-full bg-gradient-to-r from-rose-500 to-pink-500 text-white font-serif tracking-wide text-base sm:text-lg md:text-xl shadow-[0_0_20px_rgba(255,80,120,0.5)] hover:shadow-[0_0_35px_rgba(255,80,120,0.8)] transition-all hover:scale-105 active:scale-95 ${!showNext && 'pointer-events-none'}`}
          >
            Next ♥
          </button>
        </motion.div>
