        ...
        <div className="flex flex-wrap justify-center gap-1.5 sm:gap-2 w-full">
          {alphabet.map(char => (
            <button
              ...
              className="w-[9vw] h-[9vw] min-w-[36px] min-h-[36px] max-w-[48px] max-h-[48px] sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-stone-700/60 border border-amber-700/40 text-white text-xs sm:text-sm md:text-base font-sans hover:bg-amber-700/50 hover:scale-110 active:scale-95 transition-all flex items-center justify-center"
            >
              {char}
            </button>
          ))}
          <button
            ...
            className="px-4 h-[9vw] min-h-[36px] max-h-[48px] sm:h-10 md:h-12 rounded-full bg-stone-700/60 border border-amber-700/40 text-white font-sans hover:bg-amber-700/50 active:scale-95 transition-all text-xs sm:text-sm flex items-center justify-center"
          >
            ⌫
          </button>
        </div>
